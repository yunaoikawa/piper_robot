...
<div class=row><button onclick="cmd('start')">START</button><button class=warn onclick="cmd('pause')">PAUSE</button><button class=ok onclick="cmd('resume')">RESUME</button></div>
