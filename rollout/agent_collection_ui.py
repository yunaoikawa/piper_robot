...
<div class=row><select id=arm><option value=right selected>右腕 ACT bias</option><option value=left>左腕 observer bias</option></select><select id=step><option value=1>1 mm</option><option value=2 selected>2 mm</option><option value=5>5 mm</option></select></div>
<div class=axis><button onclick="n('x',-1)">X−</button><button onclick="n('y',-1)">Y−</button><button onclick="n('z',-1)">Z− ↓</button><button onclick="n('x',1)">X＋</button><button onclick="n('y',1)">Y＋</button><button onclick="n('z',1)">Z＋ ↑</button></div>
